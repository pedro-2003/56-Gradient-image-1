...
RECIPES = {
    ...
    "ideogram4":  ["--rank", "16", "--lr", "2e-4", "--include", "layers[.][0-9]+[.](attention|adaln_modulation|feed_forward)"],   # block layers only: the evaluator re-quantises every patched tensor; the 7 embedder/final-layer tensors alone cost 0.7% (probe_requant 2026-09-24)
