...
def main():
    ...
    cfg = types.SimpleNamespace(
        ...
        empty_prompt_frac=0.5, select_metric="mean", eval_every=0, holdout_names="", replan=a.replan, replan_max_members=3, init_lora=a.init_lora, flip=False, adaptive_cadence=a.adaptive_cadence)
